...
namespace weatherapp
{
    public partial class Form1 : Form
    {
        ...
        private void showButtn_Click(object sender, EventArgs e)
        {
            ...
            {
                string newPhase = "";
                if (phase is "New Moon") { newPhase = "Jauns Mēness"; }
                if (phase is "Waxing Crescent" or "First Quarter" or "Waxing Gibbous") { newPhase = "Augošs Mēness"; }
                if (phase is "Full Moon") { newPhase = "Pilns Mēness"; }
                if (phase is "Waning Gibbous" or "Third Quarter" or "Waning Crescent") { newPhase = "Dilstošs Mēness"; }
                return newPhase;
            }
            try
            {
